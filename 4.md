...
查看Mermaid流程图语法-->[点击这里](2023-08-05-22-00-00)
...
```python
  def fillable(stock, merch, n):
    return True if merch in stock and stock.get(merch, 0) >= n else False
```
